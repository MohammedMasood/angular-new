(function ($) {
    ...
    new Chart(ctxProductivity, {
	 ...
	 var ctxProductivity = document.getElementById('chart-productivity1').getContext('2d');
    new Chart(ctxProductivity, {
        type: 'line',
        data: {
            labels: ["Page A", "Page B", "Page C", "Page D", "Page E", "Page F", "Page G"],
	 ...
	 var ctxProductivity = document.getElementById('chart-productivity2').getContext('2d');
    new Chart(ctxProductivity, {
        type: 'line',
        data: {
            labels: ["Page A", "Page B", "Page C", "Page D", "Page E", "Page F", "Page G"],
	 ...
	 var ctxProductivity = document.getElementById('chart-productivity3').getContext('2d');
    new Chart(ctxProductivity, {
        type: 'line',
        data: {
            labels: ["Page A", "Page B", "Page C", "Page D", "Page E", "Page F", "Page G"],
